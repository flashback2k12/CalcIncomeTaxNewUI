...
public class AdressBildschirm extends JFrame {
	...
	public AdressBildschirm() {
		...
		txt_StraﬂeWO = new JTextField();
		txt_StraﬂeWO.setColumns(10);
		txt_StraﬂeWO.setBounds(195, 92, 145, 20);
		contentPane.add(txt_StraﬂeWO);
		...
		txt_StraﬂeAG = new JTextField();
		txt_StraﬂeAG.setColumns(10);
		txt_StraﬂeAG.setBounds(195, 235, 145, 20);
		contentPane.add(txt_StraﬂeAG);
